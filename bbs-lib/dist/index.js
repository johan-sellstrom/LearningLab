...
export function toMessageBytes(messages) {
...
export async function signMessages(messages, secretKey, publicKey) {
...
export async function deriveProof(signature, publicKey, messages, revealed, nonce = 'nonce') {
...
export async function verifySignature(messages, signature, publicKey) {
...
export async function verifyProof(proof, publicKey, revealedMessages, nonce = 'nonce') {
